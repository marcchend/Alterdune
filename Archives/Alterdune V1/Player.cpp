...
void Player::addItem(const Item& item) { 
    // Systeme d'items non implemente - cette methode ne fait rien
    // inventory.push_back(item); 
}

std::vector<Item>& Player::getInventory() { 
    // Retourne un vecteur vide
    static std::vector<Item> emptyInventory;
...
void Player::displayInventory() const {
    std::cout << "\n=== Inventaire ===\n";
    std::cout << "  [NON DISPONIBLE] Le systeme d'items sera implemente dans une version future.\n";
}
